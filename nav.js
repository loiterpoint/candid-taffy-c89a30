...
(function () {
  ...
  var css = [
    ...
    "#lpSiteFilter{position:sticky;top:56px;z-index:50;background:rgba(12,12,14,0.98);border-bottom:1px solid var(--border,#26262e);padding:0.9rem 0;margin:0.6rem 0 1.6rem;font-family:'Inter',sans-serif;}",
