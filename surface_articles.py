...
KEYWORD_RULES: list[tuple[tuple[str, ...], str]] = [
    ...
    (("power-bank", "power-station", "solar-charger", "wireless-charger",
      "ups-battery"), "power"),
    (("apple-tv", "roku", "streaming-device", "oled-tv", "tvs-under", "projector",
      "-tv-", "google-tv", "fire-tv"), "streaming"),
    ...
    (("tablet", "smartwatch", "fitness-tracker", "sleep-tracker", "ereader",
      "e-reader", "bluetooth-tracker", "handheld-gaming", "vr-headset"), "mobile-tech"),
